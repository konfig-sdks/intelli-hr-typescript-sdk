...
/**
 * This class provides a wrapper for network errors when making requests to intelliHR Public API
 */
export class IntelliHrError extends Error {
  /**
   * The response body
   */
