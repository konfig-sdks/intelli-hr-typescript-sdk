 ...
 * 
 * @export
 * @interface JobEndRemoveResponseDataJobSupervisorPersonOneOf
 */
export interface JobEndRemoveResponseDataJobSupervisorPersonOneOf {
    /**
     ...
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobSupervisorPersonOneOf
     */
    'id'?: string;
    /**
