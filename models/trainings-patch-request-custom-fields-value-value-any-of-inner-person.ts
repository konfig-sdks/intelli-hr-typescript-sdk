 ...
 * @export
 * @interface TrainingsPatchRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface TrainingsPatchRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof TrainingsPatchRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
