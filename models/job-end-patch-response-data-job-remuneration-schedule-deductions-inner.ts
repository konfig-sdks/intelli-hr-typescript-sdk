 ...
 * 
 * @export
 * @interface JobEndPatchResponseDataJobRemunerationScheduleDeductionsInner
 */
export interface JobEndPatchResponseDataJobRemunerationScheduleDeductionsInner {
    /**
     * The name of this Deduction.
     * @type {string}
     * @memberof JobEndPatchResponseDataJobRemunerationScheduleDeductionsInner
     */
    'name'?: string;
    /**
