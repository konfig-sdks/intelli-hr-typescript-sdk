 ...
 * @export
 * @interface JobCreateRequestRemunerationScheduleBreakdownsInnerDefaultRemunerationComponent
 */
export interface JobCreateRequestRemunerationScheduleBreakdownsInnerDefaultRemunerationComponent {
    /**
     * The identifier string for the default remuneration component.
     * @type {string}
     * @memberof JobCreateRequestRemunerationScheduleBreakdownsInnerDefaultRemunerationComponent
     */
    'id'?: string;
    /**
