 ...
 * @export
 * @interface JobCreateRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerJob
 */
export interface JobCreateRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof JobCreateRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
