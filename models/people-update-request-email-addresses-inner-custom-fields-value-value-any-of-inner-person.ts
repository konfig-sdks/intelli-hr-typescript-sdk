 ...
 * @export
 * @interface PeopleUpdateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleUpdateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleUpdateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
