 ...
 * @export
 * @interface JobPatchRequestRemunerationScheduleAdditionsInnerDefaultRemunerationComponent
 */
export interface JobPatchRequestRemunerationScheduleAdditionsInnerDefaultRemunerationComponent {
    /**
     * The identifier string for the default remuneration component.
     * @type {string}
     * @memberof JobPatchRequestRemunerationScheduleAdditionsInnerDefaultRemunerationComponent
     */
    'id'?: string;
    /**
