...
import { JobProperty3SupervisorPersonOneOf } from './job-property3-supervisor-person-one-of';
 ...
 * @export
 */
export type JobProperty3SupervisorPerson = JobProperty3SupervisorPersonOneOf | Null;
