 ...
 * 
 * @export
 * @interface JobProperty3RemunerationScheduleAdditionsInner
 */
export interface JobProperty3RemunerationScheduleAdditionsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobProperty3RemunerationScheduleAdditionsInner
     */
    'name'?: string;
    /**
