 ...
 * 
 * @export
 * @interface JobProperty3RemunerationScheduleAdditionsToTotalInner
 */
export interface JobProperty3RemunerationScheduleAdditionsToTotalInner {
    /**
     * The name of this Total Addition.
     * @type {string}
     * @memberof JobProperty3RemunerationScheduleAdditionsToTotalInner
     */
    'name'?: string;
    /**
