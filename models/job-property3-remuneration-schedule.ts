...
import { JobProperty3RemunerationScheduleAdditionsInner } from './job-property3-remuneration-schedule-additions-inner';
import { JobProperty3RemunerationScheduleAdditionsToTotalInner } from './job-property3-remuneration-schedule-additions-to-total-inner';
import { JobProperty3RemunerationScheduleBreakdownsInner } from './job-property3-remuneration-schedule-breakdowns-inner';
import { JobProperty3RemunerationScheduleDeductionsInner } from './job-property3-remuneration-schedule-deductions-inner';
import { JobProperty3RemunerationScheduleEmploymentCondition } from './job-property3-remuneration-schedule-employment-condition';
 ...
 * @export
 * @interface JobProperty3RemunerationSchedule
 */
export interface JobProperty3RemunerationSchedule {
    /**
     ...
     * @type {string}
     * @memberof JobProperty3RemunerationSchedule
     */
    'type'?: string;
    /**
    ...
    /**
     * 
     * @type {JobProperty3RemunerationScheduleEmploymentCondition}
     * @memberof JobProperty3RemunerationSchedule
     * @deprecated
     */
    'employmentCondition'?: JobProperty3RemunerationScheduleEmploymentCondition;
    /**
     * An array of Additions for this Remuneration Schedule.
     * @type {Array<JobProperty3RemunerationScheduleAdditionsInner>}
     * @memberof JobProperty3RemunerationSchedule
     */
    'additions'?: Array<JobProperty3RemunerationScheduleAdditionsInner>;
    /**
     ...
     * @type {Array<JobProperty3RemunerationScheduleDeductionsInner>}
     * @memberof JobProperty3RemunerationSchedule
     * @deprecated
     */
    'deductions'?: Array<JobProperty3RemunerationScheduleDeductionsInner>;
    /**
     * An array of Additions applied to the package after all other components for this Remuneration Schedule.
     * @type {Array<JobProperty3RemunerationScheduleAdditionsToTotalInner>}
     * @memberof JobProperty3RemunerationSchedule
     */
    'additionsToTotal'?: Array<JobProperty3RemunerationScheduleAdditionsToTotalInner>;
    /**
     * An array of Breakdowns for this Remuneration Schedule. Breakdowns will not be used to calculate the total package.
     * @type {Array<JobProperty3RemunerationScheduleBreakdownsInner>}
     * @memberof JobProperty3RemunerationSchedule
     */
    'breakdowns'?: Array<JobProperty3RemunerationScheduleBreakdownsInner>;
    /**
