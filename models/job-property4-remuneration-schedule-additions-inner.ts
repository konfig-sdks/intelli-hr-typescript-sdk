 ...
 * 
 * @export
 * @interface JobProperty4RemunerationScheduleAdditionsInner
 */
export interface JobProperty4RemunerationScheduleAdditionsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobProperty4RemunerationScheduleAdditionsInner
     */
    'name'?: string;
    /**
