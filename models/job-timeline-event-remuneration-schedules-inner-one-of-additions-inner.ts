 ...
 * 
 * @export
 * @interface JobTimelineEventRemunerationSchedulesInnerOneOfAdditionsInner
 */
export interface JobTimelineEventRemunerationSchedulesInnerOneOfAdditionsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobTimelineEventRemunerationSchedulesInnerOneOfAdditionsInner
     */
    'name'?: string;
    /**
