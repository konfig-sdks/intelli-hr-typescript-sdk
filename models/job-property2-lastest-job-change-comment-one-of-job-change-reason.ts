 ...
 * @export
 * @interface JobProperty2LastestJobChangeCommentOneOfJobChangeReason
 */
export interface JobProperty2LastestJobChangeCommentOneOfJobChangeReason {
    /**
     * The identifier string for the [Job Change Reason](https://developers.intellihr.io/docs/v1/) to which this Job Comment belongs.
     * @type {string}
     * @memberof JobProperty2LastestJobChangeCommentOneOfJobChangeReason
     */
    'id'?: string;
    /**
