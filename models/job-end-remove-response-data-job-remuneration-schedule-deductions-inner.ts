 ...
 * 
 * @export
 * @interface JobEndRemoveResponseDataJobRemunerationScheduleDeductionsInner
 */
export interface JobEndRemoveResponseDataJobRemunerationScheduleDeductionsInner {
    /**
     * The name of this Deduction.
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobRemunerationScheduleDeductionsInner
     */
    'name'?: string;
    /**
