 ...
 * 
 * @export
 * @interface JobEndPatchResponseDataJobRemunerationScheduleAdditionsToTotalInner
 */
export interface JobEndPatchResponseDataJobRemunerationScheduleAdditionsToTotalInner {
    /**
     * The name of this Total Addition.
     * @type {string}
     * @memberof JobEndPatchResponseDataJobRemunerationScheduleAdditionsToTotalInner
     */
    'name'?: string;
    /**
