 ...
 * @export
 * @interface JobEndPatchResponseDataJobPayGradePayStepOneOf
 */
export interface JobEndPatchResponseDataJobPayGradePayStepOneOf {
    /**
     * User friendly name for this pay step.
     * @type {string}
     * @memberof JobEndPatchResponseDataJobPayGradePayStepOneOf
     */
    'name'?: string;
    /**
