 ...
 * 
 * @export
 * @interface JobProperty4RemunerationScheduleDeductionsInner
 */
export interface JobProperty4RemunerationScheduleDeductionsInner {
    /**
     * The name of this Deduction.
     * @type {string}
     * @memberof JobProperty4RemunerationScheduleDeductionsInner
     */
    'name'?: string;
    /**
