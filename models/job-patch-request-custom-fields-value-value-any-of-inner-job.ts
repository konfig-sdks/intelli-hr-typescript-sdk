 ...
 * @export
 * @interface JobPatchRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface JobPatchRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof JobPatchRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
