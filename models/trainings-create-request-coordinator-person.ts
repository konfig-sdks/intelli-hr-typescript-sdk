 ...
 * @export
 * @interface TrainingsCreateRequestCoordinatorPerson
 */
export interface TrainingsCreateRequestCoordinatorPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof TrainingsCreateRequestCoordinatorPerson
     */
    'id'?: string;
    /**
