 ...
 * @export
 * @interface PeopleCreateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleCreateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleCreateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
