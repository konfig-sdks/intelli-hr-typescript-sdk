...
import { JobProperty4PayGradePayStepOneOf } from './job-property4-pay-grade-pay-step-one-of';

/**
 * @type JobProperty4PayGradePayStep
 * @export
 */
export type JobProperty4PayGradePayStep = JobProperty4PayGradePayStepOneOf | Null;
