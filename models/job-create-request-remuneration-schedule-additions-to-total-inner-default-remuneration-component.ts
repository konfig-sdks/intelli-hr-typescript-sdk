 ...
 * @export
 * @interface JobCreateRequestRemunerationScheduleAdditionsToTotalInnerDefaultRemunerationComponent
 */
export interface JobCreateRequestRemunerationScheduleAdditionsToTotalInnerDefaultRemunerationComponent {
    /**
     * The identifier string for the default remuneration component.
     * @type {string}
     * @memberof JobCreateRequestRemunerationScheduleAdditionsToTotalInnerDefaultRemunerationComponent
     */
    'id'?: string;
    /**
