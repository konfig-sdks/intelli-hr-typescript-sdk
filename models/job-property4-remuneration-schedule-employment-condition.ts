 ...
 * @export
 * @interface JobProperty4RemunerationScheduleEmploymentCondition
 */
export interface JobProperty4RemunerationScheduleEmploymentCondition {
    /**
     * The identifier string for the [Employment Condition](https://developers.intellihr.io/docs/v1/) of this Remuneration Schedule.
     * @type {string}
     * @memberof JobProperty4RemunerationScheduleEmploymentCondition
     */
    'id'?: string;
    /**
