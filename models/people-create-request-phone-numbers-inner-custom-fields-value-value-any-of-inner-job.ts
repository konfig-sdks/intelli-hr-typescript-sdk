 ...
 * @export
 * @interface PeopleCreateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleCreateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleCreateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
