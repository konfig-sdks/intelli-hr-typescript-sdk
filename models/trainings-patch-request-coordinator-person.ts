 ...
 * @export
 * @interface TrainingsPatchRequestCoordinatorPerson
 */
export interface TrainingsPatchRequestCoordinatorPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof TrainingsPatchRequestCoordinatorPerson
     */
    'id'?: string;
    /**
