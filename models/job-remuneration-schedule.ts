...
import { JobRemunerationScheduleAdditionsInner } from './job-remuneration-schedule-additions-inner';
import { JobRemunerationScheduleAdditionsToTotalInner } from './job-remuneration-schedule-additions-to-total-inner';
import { JobRemunerationScheduleBreakdownsInner } from './job-remuneration-schedule-breakdowns-inner';
import { JobRemunerationScheduleDeductionsInner } from './job-remuneration-schedule-deductions-inner';
import { JobRemunerationScheduleEmploymentCondition } from './job-remuneration-schedule-employment-condition';
 ...
 * @export
 * @interface JobRemunerationSchedule
 */
export interface JobRemunerationSchedule {
    /**
     ...
     * @type {string}
     * @memberof JobRemunerationSchedule
     */
    'type'?: string;
    /**
    ...
    /**
     * 
     * @type {JobRemunerationScheduleEmploymentCondition}
     * @memberof JobRemunerationSchedule
     * @deprecated
     */
    'employmentCondition'?: JobRemunerationScheduleEmploymentCondition;
    /**
     * An array of Additions for this Remuneration Schedule.
     * @type {Array<JobRemunerationScheduleAdditionsInner>}
     * @memberof JobRemunerationSchedule
     */
    'additions'?: Array<JobRemunerationScheduleAdditionsInner>;
    /**
     ...
     * @type {Array<JobRemunerationScheduleDeductionsInner>}
     * @memberof JobRemunerationSchedule
     * @deprecated
     */
    'deductions'?: Array<JobRemunerationScheduleDeductionsInner>;
    /**
     * An array of Additions applied to the package after all other components for this Remuneration Schedule.
     * @type {Array<JobRemunerationScheduleAdditionsToTotalInner>}
     * @memberof JobRemunerationSchedule
     */
    'additionsToTotal'?: Array<JobRemunerationScheduleAdditionsToTotalInner>;
    /**
     * An array of Breakdowns for this Remuneration Schedule. Breakdowns will not be used to calculate the total package.
     * @type {Array<JobRemunerationScheduleBreakdownsInner>}
     * @memberof JobRemunerationSchedule
     */
    'breakdowns'?: Array<JobRemunerationScheduleBreakdownsInner>;
    /**
