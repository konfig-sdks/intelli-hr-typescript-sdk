...
import { JobProperty2PayGradePayStepOneOf } from './job-property2-pay-grade-pay-step-one-of';

/**
 * @type JobProperty2PayGradePayStep
 * @export
 */
export type JobProperty2PayGradePayStep = JobProperty2PayGradePayStepOneOf | Null;
