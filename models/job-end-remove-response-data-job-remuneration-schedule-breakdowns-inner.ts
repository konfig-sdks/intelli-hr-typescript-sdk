 ...
 * 
 * @export
 * @interface JobEndRemoveResponseDataJobRemunerationScheduleBreakdownsInner
 */
export interface JobEndRemoveResponseDataJobRemunerationScheduleBreakdownsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobRemunerationScheduleBreakdownsInner
     */
    'name'?: string;
    /**
