 ...
 * 
 * @export
 * @interface JobEndRemoveResponseDataJobRemunerationScheduleAdditionsInner
 */
export interface JobEndRemoveResponseDataJobRemunerationScheduleAdditionsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobRemunerationScheduleAdditionsInner
     */
    'name'?: string;
    /**
