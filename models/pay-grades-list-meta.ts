...
import { PayGradesListMetaPagination } from './pay-grades-list-meta-pagination';

/**
 * Contains miscellaneous meta information about the response.
 * @export
 * @interface PayGradesListMeta
 */
export interface PayGradesListMeta {
    /**
     ...
     * @type {string}
     * @memberof PayGradesListMeta
     */
    'asAt'?: string;
    /**
     * 
     * @type {PayGradesListMetaPagination}
     * @memberof PayGradesListMeta
     */
    'pagination'?: PayGradesListMetaPagination;
    /**
