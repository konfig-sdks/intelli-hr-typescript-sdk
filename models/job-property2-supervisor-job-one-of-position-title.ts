 ...
 * @export
 * @interface JobProperty2SupervisorJobOneOfPositionTitle
 */
export interface JobProperty2SupervisorJobOneOfPositionTitle {
    /**
     ...
     * @type {string}
     * @memberof JobProperty2SupervisorJobOneOfPositionTitle
     */
    'id'?: string;
    /**
