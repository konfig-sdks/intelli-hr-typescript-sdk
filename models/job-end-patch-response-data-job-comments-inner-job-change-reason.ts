 ...
 * @export
 * @interface JobEndPatchResponseDataJobCommentsInnerJobChangeReason
 */
export interface JobEndPatchResponseDataJobCommentsInnerJobChangeReason {
    /**
     * The identifier string for the [Job Change Reason](https://developers.intellihr.io/docs/v1/) to which this Job Comment belongs.
     * @type {string}
     * @memberof JobEndPatchResponseDataJobCommentsInnerJobChangeReason
     */
    'id'?: string;
    /**
