 ...
 * @export
 * @interface JobEndRemoveResponseDataJobBusinessUnit
 */
export interface JobEndRemoveResponseDataJobBusinessUnit {
    /**
     ...
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobBusinessUnit
     */
    'id'?: string;
    /**
