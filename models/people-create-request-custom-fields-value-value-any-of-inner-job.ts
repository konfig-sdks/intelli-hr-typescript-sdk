 ...
 * @export
 * @interface PeopleCreateRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleCreateRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleCreateRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
