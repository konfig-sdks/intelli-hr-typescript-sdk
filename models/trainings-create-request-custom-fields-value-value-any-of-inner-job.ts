 ...
 * @export
 * @interface TrainingsCreateRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface TrainingsCreateRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof TrainingsCreateRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
