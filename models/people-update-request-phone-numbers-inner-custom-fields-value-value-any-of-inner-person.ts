 ...
 * @export
 * @interface PeopleUpdateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleUpdateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleUpdateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
