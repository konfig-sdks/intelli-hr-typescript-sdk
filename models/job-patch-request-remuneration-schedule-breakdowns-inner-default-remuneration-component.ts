 ...
 * @export
 * @interface JobPatchRequestRemunerationScheduleBreakdownsInnerDefaultRemunerationComponent
 */
export interface JobPatchRequestRemunerationScheduleBreakdownsInnerDefaultRemunerationComponent {
    /**
     * The identifier string for the default remuneration component.
     * @type {string}
     * @memberof JobPatchRequestRemunerationScheduleBreakdownsInnerDefaultRemunerationComponent
     */
    'id'?: string;
    /**
