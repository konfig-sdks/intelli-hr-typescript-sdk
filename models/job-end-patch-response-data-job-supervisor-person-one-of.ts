 ...
 * 
 * @export
 * @interface JobEndPatchResponseDataJobSupervisorPersonOneOf
 */
export interface JobEndPatchResponseDataJobSupervisorPersonOneOf {
    /**
     ...
     * @type {string}
     * @memberof JobEndPatchResponseDataJobSupervisorPersonOneOf
     */
    'id'?: string;
    /**
