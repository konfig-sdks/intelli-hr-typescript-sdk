 ...
 * @export
 * @interface PeopleUpdateRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleUpdateRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleUpdateRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
