 ...
 * @export
 * @interface BusinessEntitiesCreateRequestCustomFieldsValueValueAnyOf2InnerPerson
 */
export interface BusinessEntitiesCreateRequestCustomFieldsValueValueAnyOf2InnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof BusinessEntitiesCreateRequestCustomFieldsValueValueAnyOf2InnerPerson
     */
    'id'?: string;
    /**
