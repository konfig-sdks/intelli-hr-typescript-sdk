 ...
 * 
 * @export
 * @interface JobProperty2RemunerationScheduleBreakdownsInner
 */
export interface JobProperty2RemunerationScheduleBreakdownsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobProperty2RemunerationScheduleBreakdownsInner
     */
    'name'?: string;
    /**
