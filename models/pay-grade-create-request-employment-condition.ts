 ...
 * @export
 * @interface PayGradeCreateRequestEmploymentCondition
 */
export interface PayGradeCreateRequestEmploymentCondition {
    /**
     * The identifier string for the [Employment Condition](https://developers.intellihr.io/docs/v1/) of this Remuneration Schedule.
     * @type {string}
     * @memberof PayGradeCreateRequestEmploymentCondition
     */
    'id'?: string;
    /**
