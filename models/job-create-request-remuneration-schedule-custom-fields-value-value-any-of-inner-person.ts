 ...
 * @export
 * @interface JobCreateRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerPerson
 */
export interface JobCreateRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof JobCreateRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
