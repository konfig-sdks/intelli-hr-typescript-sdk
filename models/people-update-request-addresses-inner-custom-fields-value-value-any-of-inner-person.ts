 ...
 * @export
 * @interface PeopleUpdateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleUpdateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleUpdateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
