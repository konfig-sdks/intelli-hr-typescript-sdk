 ...
 * @export
 * @interface JobProperty2CommentsInnerJobChangeReason
 */
export interface JobProperty2CommentsInnerJobChangeReason {
    /**
     * The identifier string for the [Job Change Reason](https://developers.intellihr.io/docs/v1/) to which this Job Comment belongs.
     * @type {string}
     * @memberof JobProperty2CommentsInnerJobChangeReason
     */
    'id'?: string;
    /**
