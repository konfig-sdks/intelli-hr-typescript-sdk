 ...
 * @export
 * @interface PeopleUpdateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleUpdateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleUpdateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
