 ...
 * @export
 * @interface BusinessUnitsCreateRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface BusinessUnitsCreateRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof BusinessUnitsCreateRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
