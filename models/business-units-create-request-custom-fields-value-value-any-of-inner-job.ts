 ...
 * @export
 * @interface BusinessUnitsCreateRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface BusinessUnitsCreateRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof BusinessUnitsCreateRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
