...
import { JobEndRemoveResponseDataJobRemunerationScheduleAdditionsInner } from './job-end-remove-response-data-job-remuneration-schedule-additions-inner';
import { JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotalInner } from './job-end-remove-response-data-job-remuneration-schedule-additions-to-total-inner';
import { JobEndRemoveResponseDataJobRemunerationScheduleBreakdownsInner } from './job-end-remove-response-data-job-remuneration-schedule-breakdowns-inner';
import { JobEndRemoveResponseDataJobRemunerationScheduleDeductionsInner } from './job-end-remove-response-data-job-remuneration-schedule-deductions-inner';
import { JobEndRemoveResponseDataJobRemunerationScheduleEmploymentCondition } from './job-end-remove-response-data-job-remuneration-schedule-employment-condition';
 ...
 * @export
 * @interface JobEndRemoveResponseDataJobRemunerationSchedule
 */
export interface JobEndRemoveResponseDataJobRemunerationSchedule {
    /**
     ...
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobRemunerationSchedule
     */
    'type'?: string;
    /**
    ...
    /**
     * 
     * @type {JobEndRemoveResponseDataJobRemunerationScheduleEmploymentCondition}
     * @memberof JobEndRemoveResponseDataJobRemunerationSchedule
     * @deprecated
     */
    'employmentCondition'?: JobEndRemoveResponseDataJobRemunerationScheduleEmploymentCondition;
    /**
     * An array of Additions for this Remuneration Schedule.
     * @type {Array<JobEndRemoveResponseDataJobRemunerationScheduleAdditionsInner>}
     * @memberof JobEndRemoveResponseDataJobRemunerationSchedule
     */
    'additions'?: Array<JobEndRemoveResponseDataJobRemunerationScheduleAdditionsInner>;
    /**
     ...
     * @type {Array<JobEndRemoveResponseDataJobRemunerationScheduleDeductionsInner>}
     * @memberof JobEndRemoveResponseDataJobRemunerationSchedule
     * @deprecated
     */
    'deductions'?: Array<JobEndRemoveResponseDataJobRemunerationScheduleDeductionsInner>;
    /**
     * An array of Additions applied to the package after all other components for this Remuneration Schedule.
     * @type {Array<JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotalInner>}
     * @memberof JobEndRemoveResponseDataJobRemunerationSchedule
     */
    'additionsToTotal'?: Array<JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotalInner>;
    /**
     * An array of Breakdowns for this Remuneration Schedule. Breakdowns will not be used to calculate the total package.
     * @type {Array<JobEndRemoveResponseDataJobRemunerationScheduleBreakdownsInner>}
     * @memberof JobEndRemoveResponseDataJobRemunerationSchedule
     */
    'breakdowns'?: Array<JobEndRemoveResponseDataJobRemunerationScheduleBreakdownsInner>;
    /**
