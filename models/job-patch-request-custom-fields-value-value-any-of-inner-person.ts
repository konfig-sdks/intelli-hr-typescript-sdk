 ...
 * @export
 * @interface JobPatchRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface JobPatchRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof JobPatchRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
