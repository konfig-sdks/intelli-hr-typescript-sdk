 ...
 * 
 * @export
 * @interface JobProperty3RemunerationScheduleDeductionsInner
 */
export interface JobProperty3RemunerationScheduleDeductionsInner {
    /**
     * The name of this Deduction.
     * @type {string}
     * @memberof JobProperty3RemunerationScheduleDeductionsInner
     */
    'name'?: string;
    /**
