 ...
 * @export
 * @interface PeopleCreateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleCreateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleCreateRequestEmailAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
