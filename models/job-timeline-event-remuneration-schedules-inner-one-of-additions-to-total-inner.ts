 ...
 * 
 * @export
 * @interface JobTimelineEventRemunerationSchedulesInnerOneOfAdditionsToTotalInner
 */
export interface JobTimelineEventRemunerationSchedulesInnerOneOfAdditionsToTotalInner {
    /**
     * The name of this Total Addition.
     * @type {string}
     * @memberof JobTimelineEventRemunerationSchedulesInnerOneOfAdditionsToTotalInner
     */
    'name'?: string;
    /**
