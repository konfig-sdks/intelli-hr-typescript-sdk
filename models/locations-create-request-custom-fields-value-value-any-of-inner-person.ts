 ...
 * @export
 * @interface LocationsCreateRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface LocationsCreateRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof LocationsCreateRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
