 ...
 * @export
 * @interface BusinessEntitiesCreateRequestCustomFieldsValueValueAnyOf2InnerJob
 */
export interface BusinessEntitiesCreateRequestCustomFieldsValueValueAnyOf2InnerJob {
    /**
     ...
     * @type {string}
     * @memberof BusinessEntitiesCreateRequestCustomFieldsValueValueAnyOf2InnerJob
     */
    'id'?: string;
    /**
