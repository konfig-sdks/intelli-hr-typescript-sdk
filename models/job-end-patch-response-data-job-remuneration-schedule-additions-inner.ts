 ...
 * 
 * @export
 * @interface JobEndPatchResponseDataJobRemunerationScheduleAdditionsInner
 */
export interface JobEndPatchResponseDataJobRemunerationScheduleAdditionsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobEndPatchResponseDataJobRemunerationScheduleAdditionsInner
     */
    'name'?: string;
    /**
