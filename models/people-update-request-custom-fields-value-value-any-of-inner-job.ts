 ...
 * @export
 * @interface PeopleUpdateRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleUpdateRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleUpdateRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
