 ...
 * @export
 * @interface JobTimelineEventRemunerationSchedulesInnerOneOfEmploymentCondition
 */
export interface JobTimelineEventRemunerationSchedulesInnerOneOfEmploymentCondition {
    /**
     * The identifier string for the [Employment Condition](https://developers.intellihr.io/docs/v1/) of this Remuneration Schedule.
     * @type {string}
     * @memberof JobTimelineEventRemunerationSchedulesInnerOneOfEmploymentCondition
     */
    'id'?: string;
    /**
