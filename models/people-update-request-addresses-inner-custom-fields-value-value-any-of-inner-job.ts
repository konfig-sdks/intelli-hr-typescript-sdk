 ...
 * @export
 * @interface PeopleUpdateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleUpdateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleUpdateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
