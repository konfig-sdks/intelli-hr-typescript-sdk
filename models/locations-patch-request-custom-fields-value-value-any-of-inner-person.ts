 ...
 * @export
 * @interface LocationsPatchRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface LocationsPatchRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof LocationsPatchRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
