 ...
 * @export
 * @interface TrainingsPatchRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface TrainingsPatchRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof TrainingsPatchRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
