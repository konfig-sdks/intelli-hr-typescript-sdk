 ...
 * @export
 * @interface JobEndRemoveResponseDataJobEstablishment
 */
export interface JobEndRemoveResponseDataJobEstablishment {
    /**
     ...
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobEstablishment
     */
    'id'?: string;
    /**
