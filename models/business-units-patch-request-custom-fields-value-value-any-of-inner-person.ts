 ...
 * @export
 * @interface BusinessUnitsPatchRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface BusinessUnitsPatchRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof BusinessUnitsPatchRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
