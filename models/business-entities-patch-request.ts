...
import { BusinessEntitiesPatchRequestCustomFieldsValue } from './business-entities-patch-request-custom-fields-value';

/**
 * 
 * @export
 * @interface BusinessEntitiesPatchRequest
 */
export interface BusinessEntitiesPatchRequest {
    /**
     ...
     * @type {string}
     * @memberof BusinessEntitiesPatchRequest
     */
    'name'?: string;
    /**
     ...
     * @type {{ [key: string]: BusinessEntitiesPatchRequestCustomFieldsValue; }}
     * @memberof BusinessEntitiesPatchRequest
     */
    'customFields'?: { [key: string]: BusinessEntitiesPatchRequestCustomFieldsValue; };
}
