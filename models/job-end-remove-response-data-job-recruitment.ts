...
import { JobEndRemoveResponseDataJobRecruitmentSource } from './job-end-remove-response-data-job-recruitment-source';

/**
 * The recruitment details stored for this [Job](https://developers.intellihr.io/docs/v1/).
 * @export
 * @interface JobEndRemoveResponseDataJobRecruitment
 */
export interface JobEndRemoveResponseDataJobRecruitment {
    /**
     * 
     * @type {JobEndPatchResponseDataJobRecruitmentCost}
     * @memberof JobEndRemoveResponseDataJobRecruitment
     */
     ...
     * @memberof JobEndRemoveResponseDataJobRecruitment
     */
    'source'?: JobEndRemoveResponseDataJobRecruitmentSource;
}
