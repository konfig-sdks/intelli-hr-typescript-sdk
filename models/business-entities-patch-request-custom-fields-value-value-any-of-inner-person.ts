 ...
 * @export
 * @interface BusinessEntitiesPatchRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface BusinessEntitiesPatchRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof BusinessEntitiesPatchRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
