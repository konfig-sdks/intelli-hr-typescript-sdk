...
import { JobProperty2RemunerationScheduleAdditionsInner } from './job-property2-remuneration-schedule-additions-inner';
import { JobProperty2RemunerationScheduleAdditionsToTotalInner } from './job-property2-remuneration-schedule-additions-to-total-inner';
import { JobProperty2RemunerationScheduleBreakdownsInner } from './job-property2-remuneration-schedule-breakdowns-inner';
import { JobProperty2RemunerationScheduleDeductionsInner } from './job-property2-remuneration-schedule-deductions-inner';
import { JobProperty2RemunerationScheduleEmploymentCondition } from './job-property2-remuneration-schedule-employment-condition';
 ...
 * @export
 * @interface JobProperty2RemunerationSchedule
 */
export interface JobProperty2RemunerationSchedule {
    /**
     ...
     * @type {string}
     * @memberof JobProperty2RemunerationSchedule
     */
    'type'?: string;
    /**
    ...
    /**
     * 
     * @type {JobProperty2RemunerationScheduleEmploymentCondition}
     * @memberof JobProperty2RemunerationSchedule
     * @deprecated
     */
    'employmentCondition'?: JobProperty2RemunerationScheduleEmploymentCondition;
    /**
     * An array of Additions for this Remuneration Schedule.
     * @type {Array<JobProperty2RemunerationScheduleAdditionsInner>}
     * @memberof JobProperty2RemunerationSchedule
     */
    'additions'?: Array<JobProperty2RemunerationScheduleAdditionsInner>;
    /**
     ...
     * @type {Array<JobProperty2RemunerationScheduleDeductionsInner>}
     * @memberof JobProperty2RemunerationSchedule
     * @deprecated
     */
    'deductions'?: Array<JobProperty2RemunerationScheduleDeductionsInner>;
    /**
     * An array of Additions applied to the package after all other components for this Remuneration Schedule.
     * @type {Array<JobProperty2RemunerationScheduleAdditionsToTotalInner>}
     * @memberof JobProperty2RemunerationSchedule
     */
    'additionsToTotal'?: Array<JobProperty2RemunerationScheduleAdditionsToTotalInner>;
    /**
     * An array of Breakdowns for this Remuneration Schedule. Breakdowns will not be used to calculate the total package.
     * @type {Array<JobProperty2RemunerationScheduleBreakdownsInner>}
     * @memberof JobProperty2RemunerationSchedule
     */
    'breakdowns'?: Array<JobProperty2RemunerationScheduleBreakdownsInner>;
    /**
