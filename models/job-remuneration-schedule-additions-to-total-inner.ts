 ...
 * 
 * @export
 * @interface JobRemunerationScheduleAdditionsToTotalInner
 */
export interface JobRemunerationScheduleAdditionsToTotalInner {
    /**
     * The name of this Total Addition.
     * @type {string}
     * @memberof JobRemunerationScheduleAdditionsToTotalInner
     */
    'name'?: string;
    /**
