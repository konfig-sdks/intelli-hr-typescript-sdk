...
import { TrainingPropertyCoordinatorOneOf } from './training-property-coordinator-one-of';
 ...
 * @export
 */
export type TrainingPropertyCoordinator = Null | TrainingPropertyCoordinatorOneOf;
