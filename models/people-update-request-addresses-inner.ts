...
import { PeopleUpdateRequestAddressesInnerCustomFieldsValue } from './people-update-request-addresses-inner-custom-fields-value';

/**
 * 
 * @export
 * @interface PeopleUpdateRequestAddressesInner
 */
export interface PeopleUpdateRequestAddressesInner {
    /**
     * Enum: `Home`, `Postal`. The type of address.
     * @type {string}
     * @memberof PeopleUpdateRequestAddressesInner
     */
    'addressType': string;
    /**
     ...
     * @type {{ [key: string]: PeopleUpdateRequestAddressesInnerCustomFieldsValue; }}
     * @memberof PeopleUpdateRequestAddressesInner
     */
    'customFields'?: { [key: string]: PeopleUpdateRequestAddressesInnerCustomFieldsValue; };
}
