 ...
 * @export
 * @interface JobEndPatchResponseDataJobEstablishment
 */
export interface JobEndPatchResponseDataJobEstablishment {
    /**
     ...
     * @type {string}
     * @memberof JobEndPatchResponseDataJobEstablishment
     */
    'id'?: string;
    /**
