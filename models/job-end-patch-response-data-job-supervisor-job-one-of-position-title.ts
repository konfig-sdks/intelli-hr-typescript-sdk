 ...
 * @export
 * @interface JobEndPatchResponseDataJobSupervisorJobOneOfPositionTitle
 */
export interface JobEndPatchResponseDataJobSupervisorJobOneOfPositionTitle {
    /**
     ...
     * @type {string}
     * @memberof JobEndPatchResponseDataJobSupervisorJobOneOfPositionTitle
     */
    'id'?: string;
    /**
