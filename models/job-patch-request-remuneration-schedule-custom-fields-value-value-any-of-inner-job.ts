 ...
 * @export
 * @interface JobPatchRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerJob
 */
export interface JobPatchRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof JobPatchRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
