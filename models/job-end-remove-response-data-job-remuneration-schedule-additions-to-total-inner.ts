 ...
 * 
 * @export
 * @interface JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotalInner
 */
export interface JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotalInner {
    /**
     * The name of this Total Addition.
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobRemunerationScheduleAdditionsToTotalInner
     */
    'name'?: string;
    /**
