...
import { JobEndRemoveResponseDataJobPayGradePayStepOneOf } from './job-end-remove-response-data-job-pay-grade-pay-step-one-of';

/**
 * @type JobEndRemoveResponseDataJobPayGradePayStep
 * @export
 */
export type JobEndRemoveResponseDataJobPayGradePayStep = JobEndRemoveResponseDataJobPayGradePayStepOneOf | Null;
