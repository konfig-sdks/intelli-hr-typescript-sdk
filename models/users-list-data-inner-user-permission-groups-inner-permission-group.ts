 ...
 * @export
 * @interface UsersListDataInnerUserPermissionGroupsInnerPermissionGroup
 */
export interface UsersListDataInnerUserPermissionGroupsInnerPermissionGroup {
    /**
     * The identifier string for the [Permission Group](https://developers.intellihr.io/docs/v1/).
     * @type {string}
     * @memberof UsersListDataInnerUserPermissionGroupsInnerPermissionGroup
     */
    'id'?: string;
    /**
