 ...
 * @export
 * @interface JobPatchRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerPerson
 */
export interface JobPatchRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof JobPatchRequestRemunerationScheduleCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
