 ...
 * @export
 * @interface JobProperty4LastestJobChangeCommentOneOfJobChangeReason
 */
export interface JobProperty4LastestJobChangeCommentOneOfJobChangeReason {
    /**
     * The identifier string for the [Job Change Reason](https://developers.intellihr.io/docs/v1/) to which this Job Comment belongs.
     * @type {string}
     * @memberof JobProperty4LastestJobChangeCommentOneOfJobChangeReason
     */
    'id'?: string;
    /**
