 ...
 * @export
 * @interface JobProperty4SupervisorJobOneOfPositionTitle
 */
export interface JobProperty4SupervisorJobOneOfPositionTitle {
    /**
     ...
     * @type {string}
     * @memberof JobProperty4SupervisorJobOneOfPositionTitle
     */
    'id'?: string;
    /**
