 ...
 * 
 * @export
 * @interface JobProperty4RemunerationScheduleBreakdownsInner
 */
export interface JobProperty4RemunerationScheduleBreakdownsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobProperty4RemunerationScheduleBreakdownsInner
     */
    'name'?: string;
    /**
