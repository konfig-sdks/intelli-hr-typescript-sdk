 ...
 * 
 * @export
 * @interface JobProperty2RemunerationScheduleAdditionsInner
 */
export interface JobProperty2RemunerationScheduleAdditionsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobProperty2RemunerationScheduleAdditionsInner
     */
    'name'?: string;
    /**
