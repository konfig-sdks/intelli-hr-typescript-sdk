 ...
 * @export
 * @interface LocationsPatchRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface LocationsPatchRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof LocationsPatchRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
