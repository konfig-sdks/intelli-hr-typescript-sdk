 ...
 * @export
 * @interface JobEndPatchResponseDataJobBusinessEntity
 */
export interface JobEndPatchResponseDataJobBusinessEntity {
    /**
     ...
     * @type {string}
     * @memberof JobEndPatchResponseDataJobBusinessEntity
     */
    'id'?: string;
    /**
