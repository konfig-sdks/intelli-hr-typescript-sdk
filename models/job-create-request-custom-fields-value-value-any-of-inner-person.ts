 ...
 * @export
 * @interface JobCreateRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface JobCreateRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof JobCreateRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
