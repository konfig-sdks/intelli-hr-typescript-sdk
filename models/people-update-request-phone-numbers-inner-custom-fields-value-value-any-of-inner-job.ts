 ...
 * @export
 * @interface PeopleUpdateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleUpdateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleUpdateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
