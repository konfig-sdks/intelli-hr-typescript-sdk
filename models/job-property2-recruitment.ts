...
import { JobProperty2RecruitmentSource } from './job-property2-recruitment-source';

/**
 * The recruitment details stored for this [Job](https://developers.intellihr.io/docs/v1/).
 * @export
 * @interface JobProperty2Recruitment
 */
export interface JobProperty2Recruitment {
    /**
     * 
     * @type {JobEndPatchResponseDataJobRecruitmentCost}
     * @memberof JobProperty2Recruitment
     */
     ...
     * @memberof JobProperty2Recruitment
     */
    'source'?: JobProperty2RecruitmentSource;
}
