 ...
 * @export
 * @interface JobEndRemoveResponseDataJobBusinessEntity
 */
export interface JobEndRemoveResponseDataJobBusinessEntity {
    /**
     ...
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobBusinessEntity
     */
    'id'?: string;
    /**
