...
/**
 * The [Person](https://developers.intellihr.io/docs/v1/) to whom this [User](https://developers.intellihr.io/docs/v1/) belongs.
 * @export
 * @interface UsersListDataInnerPerson
 */
export interface UsersListDataInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to whom this [User](https://developers.intellihr.io/docs/v1/) belongs.
     * @type {string}
     * @memberof UsersListDataInnerPerson
     */
    'id'?: string;
    /**
