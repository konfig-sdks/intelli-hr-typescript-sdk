 ...
 * @export
 * @interface PeopleCreateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleCreateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleCreateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
