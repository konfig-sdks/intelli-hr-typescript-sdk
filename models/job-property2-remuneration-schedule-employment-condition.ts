 ...
 * @export
 * @interface JobProperty2RemunerationScheduleEmploymentCondition
 */
export interface JobProperty2RemunerationScheduleEmploymentCondition {
    /**
     * The identifier string for the [Employment Condition](https://developers.intellihr.io/docs/v1/) of this Remuneration Schedule.
     * @type {string}
     * @memberof JobProperty2RemunerationScheduleEmploymentCondition
     */
    'id'?: string;
    /**
