 ...
 * @export
 * @interface JobPatchRequestRemunerationScheduleAdditionsToTotalInnerDefaultRemunerationComponent
 */
export interface JobPatchRequestRemunerationScheduleAdditionsToTotalInnerDefaultRemunerationComponent {
    /**
     * The identifier string for the default remuneration component.
     * @type {string}
     * @memberof JobPatchRequestRemunerationScheduleAdditionsToTotalInnerDefaultRemunerationComponent
     */
    'id'?: string;
    /**
