 ...
 * @export
 * @interface PeopleCreateRequestCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleCreateRequestCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleCreateRequestCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
