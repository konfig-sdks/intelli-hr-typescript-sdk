 ...
 * @export
 * @interface PeopleCreateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerPerson
 */
export interface PeopleCreateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerPerson {
    /**
     * The identifier string for the [Person](https://developers.intellihr.io/docs/v1/) to locate in the system.
     * @type {string}
     * @memberof PeopleCreateRequestPhoneNumbersInnerCustomFieldsValueValueAnyOfInnerPerson
     */
    'id'?: string;
    /**
