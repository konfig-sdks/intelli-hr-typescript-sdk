 ...
 * @export
 * @interface JobProperty3LastestJobChangeCommentOneOfJobChangeReason
 */
export interface JobProperty3LastestJobChangeCommentOneOfJobChangeReason {
    /**
     * The identifier string for the [Job Change Reason](https://developers.intellihr.io/docs/v1/) to which this Job Comment belongs.
     * @type {string}
     * @memberof JobProperty3LastestJobChangeCommentOneOfJobChangeReason
     */
    'id'?: string;
    /**
