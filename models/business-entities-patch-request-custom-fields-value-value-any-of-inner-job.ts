 ...
 * @export
 * @interface BusinessEntitiesPatchRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface BusinessEntitiesPatchRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof BusinessEntitiesPatchRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
