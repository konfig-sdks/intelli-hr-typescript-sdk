 ...
 * 
 * @export
 * @interface JobRemunerationScheduleBreakdownsInner
 */
export interface JobRemunerationScheduleBreakdownsInner {
    /**
     * The name of this Addition.
     * @type {string}
     * @memberof JobRemunerationScheduleBreakdownsInner
     */
    'name'?: string;
    /**
