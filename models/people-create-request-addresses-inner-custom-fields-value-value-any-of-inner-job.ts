 ...
 * @export
 * @interface PeopleCreateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerJob
 */
export interface PeopleCreateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof PeopleCreateRequestAddressesInnerCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
