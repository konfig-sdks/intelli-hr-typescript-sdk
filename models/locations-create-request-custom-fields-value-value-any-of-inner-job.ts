 ...
 * @export
 * @interface LocationsCreateRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface LocationsCreateRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof LocationsCreateRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
