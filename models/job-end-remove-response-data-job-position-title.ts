 ...
 * @export
 * @interface JobEndRemoveResponseDataJobPositionTitle
 */
export interface JobEndRemoveResponseDataJobPositionTitle {
    /**
     ...
     * @type {string}
     * @memberof JobEndRemoveResponseDataJobPositionTitle
     */
    'id'?: string;
    /**
