 ...
 * @export
 * @interface BusinessUnitsPatchRequestCustomFieldsValueValueAnyOfInnerJob
 */
export interface BusinessUnitsPatchRequestCustomFieldsValueValueAnyOfInnerJob {
    /**
     ...
     * @type {string}
     * @memberof BusinessUnitsPatchRequestCustomFieldsValueValueAnyOfInnerJob
     */
    'id'?: string;
    /**
