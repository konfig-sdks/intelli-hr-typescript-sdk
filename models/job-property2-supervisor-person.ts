...
import { JobProperty2SupervisorPersonOneOf } from './job-property2-supervisor-person-one-of';
 ...
 * @export
 */
export type JobProperty2SupervisorPerson = JobProperty2SupervisorPersonOneOf | Null;
