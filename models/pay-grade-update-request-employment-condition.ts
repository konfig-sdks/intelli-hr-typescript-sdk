 ...
 * @export
 * @interface PayGradeUpdateRequestEmploymentCondition
 */
export interface PayGradeUpdateRequestEmploymentCondition {
    /**
     * The identifier string for the [Employment Condition](https://developers.intellihr.io/docs/v1/) of this Remuneration Schedule.
     * @type {string}
     * @memberof PayGradeUpdateRequestEmploymentCondition
     */
    'id'?: string;
    /**
