 ...
 * @export
 * @interface JobCreateRequestRemunerationScheduleEmploymentCondition
 */
export interface JobCreateRequestRemunerationScheduleEmploymentCondition {
    /**
     * The identifier string for the [Employment Condition](https://developers.intellihr.io/docs/v1/) of this Remuneration Schedule.
     * @type {string}
     * @memberof JobCreateRequestRemunerationScheduleEmploymentCondition
     */
    'id'?: string;
    /**
