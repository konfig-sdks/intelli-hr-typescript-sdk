 ...
 * 
 * @export
 * @interface JobTimelineEventRemunerationSchedulesInnerOneOfDeductionsInner
 */
export interface JobTimelineEventRemunerationSchedulesInnerOneOfDeductionsInner {
    /**
     * The name of this Deduction.
     * @type {string}
     * @memberof JobTimelineEventRemunerationSchedulesInnerOneOfDeductionsInner
     */
    'name'?: string;
    /**
